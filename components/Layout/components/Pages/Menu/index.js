...
import {Gluten,Canada, CocaCola, CocaDiet, Sprite, Nestea, Vegan} from '../../../../../data/images';
                                            ...
                                            <div className="right-menu" style={{float:"right", width:"50%"}}>
                                                <ul>
                                                    ...
                                                    <li><strong>Pop</strong> Coke (140 Cals), Diet Coke (0 Cals), Ginger
                                                        ...
                                                        <div
                                                            className="pop-icons">
                                                            <Image src={CocaCola} width={50} height={50} alt="Coca Cola"
                                                            className="img-responsive"/>
                                                            <Image src={CocaDiet} width={50} height={50} alt="Coca Cola Diet"
                                                            className="img-responsive"/>
                                                            <Image src={Sprite} width={50} height={50} alt="Sprite"
                                                            className="img-responsive"/>
                                                            <Image src={Canada} width={50} height={50} alt="Canada Dry"
                                                            className="img-responsive"/>
