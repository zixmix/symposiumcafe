...
import Pic from "/images/delivery/delivery.jpg"
...
export default function DeliveryBody() {
    return (
        <div>
            <BodyTop title="Delivery" image={Pic}/>
            <section>
                                ...
                                <div className="delivery-locations">
                                    ...
                                    <div>
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 338 Rossland Road East, Ajax L1Z 0K4</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        ...
                                        <span className="glf-button"
                                            ...
                                            <Image src={Feastify} alt="Symposium Delivery Alliston" width={142.2}
                                                   height={44.56}/></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 1146 Wilson St. West, Ancaster L9G 3K9</span>
                                                    <br/>
                                                    <br/>
                                            ...
                                            <div className="col-md-3" id={"bloc2"} style={{float: "right"}}>
                                                <div className="delivery-logos">
                                                    ...
                                                    <a href="https://www.ubereats.com/en-CA/hamilton/food-delivery/symposium-cafe-ancaster/MBp-FAwyScKLNbIp_0Q33A/">
                                                        <Image src={Uber} alt="Symposium Delivery via Uber eats"
                                                               width={142.2} height={35.55}/></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 444 Hollandview Trail, Aurora L4G 7Z9</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 307 Cundles Road East, Barrie L4M 0G9</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 192 McEwan Drive East, Bolton L7E 4E5</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 58 King George Road, Brantford N3R 5K4</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 500 Can-Amera Parkway, Cambridge N1T 0A2</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 965 Elgin Street West, Cobourg K9A 5J3</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 235 Guelph Street, Georgetown L7G 4A8</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 304 Stone Road West, Guelph N1G 3C4</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 236 Dovedale Drive, Keswick L4P 0H3</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 449 Kent Street West, Lindsay K9V 6C3</span>
                                                    <br/>
                                                    <br/>
                                            ...
                                            <div className="col-md-3" id={"bloc2"} style={{float: "right"}}>
                                                <div className="delivery-logos">
                                                    ...
                                                    <a href="https://feastify.com/listing/symposium-cafe-lindsay/">
                                                        <Image src={Feastifybela} alt="Symposium Delivery via Feastify"
                                                               width={142.2} height={56}/></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 1500 Upper Middle Road, Oakville L6M 3G3</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 8187 Yonge Street, Thornhill L3T 2C6</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 668 Erb Street West, Waterloo N2T 2K8</span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 30 Broadleaf Avenue, Whitby L1R3N8 </span>
                                                    <br/>
                                                    <br/>
                                    ...
                                    <div className="location">
                                        <div className="row" style={{display: "inline-block", verticalAlign: "middle"}}>
                                            <div className="col-md-5" id={"bloc1"}
                                                ...
                                                <p className="location-info">
                                                    <span
                                                        className="address"> 31 Colossus Drive, Woodbridge L4L 9K4</span>
                                                    <br/>
                                                    <br/>
