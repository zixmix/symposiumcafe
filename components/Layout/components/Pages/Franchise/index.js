...
import {Award, Award1, Award2, Award3, Award4,SymposiumLogoFranchise, SymposiumCafe, FranchiseFacts, FranchiseInvestment, FAQ, ContactUs} from "../../../../../data/images";
                                                ...
                                                <div className="col-lg-4 col-sm-4 col-xs-6" style={{width:"30%", float:"left"}}>
                                                    <Link href="/franchise/whySymposium">
                                                        <div className="abs-border-mini">
                                                            <Image src={SymposiumLogoFranchise} width={151} height={100}
