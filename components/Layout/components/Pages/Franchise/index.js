...
import Pic from "/images/franchise/franchise.jpg"
import {
    Award,
    Award1,
    Award2,
                            ...
                            <div className="col-lg-12">
                                ...
                                <a href="https://symposiumcafe.com/pdf/Franchisee-Success-Story.pdf"
                                   style={{
                                    ...
                                    <span style={{textDecoration: "underline"}}>READ</span>: A FRANCHISE SUCCESS STORY
                                </a>
                                ...
                                <p>Awarded Canadian FRANCHISE OF THE YEAR for both
                                    <Link
                                        href="http://www.newswire.ca/news-releases/canadian-franchise-association-announces-winners-of-the-2017-awards-of-excellence-in-franchising-618221963.html"
                                    >2017</Link> and <Link
                                        href="http://campaign.r20.constantcontact.com/render?m=1118295573310&ca=d75cf609-bba6-41ce-9a8c-ce1191231a09"
                                ...
                                <div style={{float: "left"}}>
                                    ...
                                    <p>Since 1996, Symposium Restaurants have been “Redefining the Cafe Experience” ™ by
                                        responding and adapting to consumer dining trends: setting high standards in
                                        guest
                                        focussed service and providing quality and value for the optimum dining
                                        experience.
                                    ...
                                    continued growth through the Ontario marketplace in both franchise and corporate
                                    stores.
                                </p>
                                </div>
                                        ...
                                        <div style={{width: "50%", float: "left"}}>
                                            <div className="col-lg-6 ">
                                                <div className="row">
                                                    <div className="col-lg-4 col-sm-4 col-xs-6"
                                                        ...
                                                        <Link href="/franchise/whySymposium" passHref>
                                                            <div className="abs-border-mini">
                                                                <Image src={SymposiumLogoFranchise} width={151}
                                                                       height={100}
                                                                       alt="Why a Symposium Franchise?"
                                                    ...
                                                    <div className="col-lg-8 col-sm-8 col-xs-12"
                                                        ...
                                                        <ul>
                                                            <li>Grand Prize Winner –
                                                                <Link
                                                                    href="https://www.newswire.ca/news-releases/canadian-franchise-association-announces-winners-of-the-2017-awards-of-excellence-in-franchising-618221963.html"
                                                                    passHref>2017</Link> &
                                                                <Link
                                                                    href="http://campaign.r20.constantcontact.com/render?m=1118295573310&ca=d75cf609-bba6-41ce-9a8c-ce1191231a09"
                                                                    passHref
                                            ...
                                            <div className="col-lg-6 ">
                                                <div className="row">
                                                    <div className="col-lg-4 col-sm-4 col-xs-6"
                                                         style={{width: "30%", float: "left"}}>
                                                        <Link href="/franchise/currentLocation" passHref>
                                                            <div className="abs-border-mini">
                                                                <Image
                                                                    src={SymposiumCafe} width={151} height={100}
                                                                    alt="Current Opportunities"
                                                                    className="abs-border-img"/>
                                                            </div>
                                                        </Link>
                                                    </div>
                                        ...
                                        <div style={{width: "50%", float: "right"}}>
                                            <div className="col-lg-6 ">
                                                <div className="row">
                                                    <div className="col-lg-4 col-sm-4 col-xs-6"
                                                         style={{width: "30%", float: "left"}}>
                                                        <Link href="/franchise/franchiseFacts" passHref>
                                                            <div className="abs-border-mini">
                                                                <Image
                                                                    src={FranchiseFacts} width={151} height={100}
                                                                    alt="Franchise Facts"
                                                                    className="abs-border-img"/>
                                                            </div>
                                                        </Link>
                                                    ...
                                                    <div className="col-lg-8 col-sm-8 col-xs-12"
                                                        ...
                                                        <div className="franchise-heading"><Link
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>Sales Range of existing Franchise locations $1,100,000
                                                                to
                                                                $2,100,000
                                                            </li>
                                                        </ul>
                                            ...
                                            <div className="col-lg-6 ">
                                                <div className="row">
                                                    <div className="col-lg-4 col-sm-4 col-xs-6"
                                                         style={{width: "30%", float: "left"}}>
                                                        <Link href="/franchise/franchisingInvestment" passHref>
                                                            <div className="abs-border-mini">
                                                                <Image
                                                                    src={FranchiseInvestment} width={151} height={100}
                                            ...
                                            <div className="col-lg-6 ">
                                                <div className="row">
                                                    <div className="col-lg-4 col-sm-4 col-xs-6"
                                                         style={{width: "30%", float: "left"}}>
                                                        <Link href="/franchise/faq" passHref>
                                                            <div className="abs-border-mini">
                                                                <Image
                                                                    src={FAQ} width={151} height={100}
                                                    ...
                                                    <div className="col-lg-8 col-sm-8 col-xs-12"
                                                        ...
                                                        <div className="franchise-heading"><Link
                                                            href="/franchise/faq" passHref>FAQ</Link></div>
                                            ...
                                            <div className="col-lg-6 ">
                                                <div className="row">
                                                    <div className="col-lg-4 col-sm-4 col-xs-6"
                                                         style={{width: "30%", float: "left"}}>
                                                        {/*<Link href="/franchise/contactUs" passHref>*/}
                                                        {/*    <div className="abs-border-mini">*/}
                                                        {/*        <Image*/}
                                                        {/*            src={ContactUs} width={151} height={100}*/}
                                                    ...
                                                    <div className="col-lg-8 col-sm-8 col-xs-12"
                                                        ...
                                                        {/*<div className="franchise-heading"><Link*/}
                                                        {/*    href="/franchise/contactUs" passHref>Contact us</Link></div>*/}

                                                        <p>Our corporate office is located in North York to serve you.
                                                            Please book your
                                                            appointment at
                                                            <br/>
                                                            <Link href="tel:1-416-449-3611"
                                                                  className="bold purple-text"
                                                                  passHref>1-416-449-3611</Link>
                                                            or email
                                                            <Link href=""
                                                                  className="bold purple-text" passHref>
