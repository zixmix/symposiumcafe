                                    ...
                                    <div className="locations-content">
                                        <div className="locations-content-text">
                                            <div style={{float: "left", width: "68%"}}>
                                                ...
                                                <ul className="location-for-you-list">
                                                    <li> Full service Breakfast/Brunch menu: Omelettes, Waffles, French
                                                        Toast,
                                                        Freshly squeezed
                                                        juices
                                                    </li>
                                                    <li> Lunch menu: burgers, salads, soup, appetizers, sandwiches, and
                                                        full
                                                        breakfast menu til
                                                        4 pm
                                                    </li>
                                                    ...
                                                    <li> Fully licensed lounge: specialty cocktails, over 30 martini
                                                        options, 12
                                                        beer on tap, 34
                                                        varieties of wine, specialty coffee beverages.
                                                    </li>
                                                    <li> Restaurant open early mornings and late nights</li>
                                                    <li> Late Night Kitchen & Dining: full restaurant menu available
                                                        until
                                                        closing including
                                                    ...
                                                    <li> Extensive menu selection of desserts: cakes, freshly made
                                                        waffles,
                                                        ice-cream, crepes
                                                    </li>
                                                </ul>
                                            ...
                                            <div className="location-content-widget"
                                                ...
                                                <div className="">
                                                    <div className="yellow-bg">
                                                        ...
                                                        <div className="delivery-location">
                                                            <div className="header-h2"
                                                                ...
                                                                <h2 style={{
                                                                    ...
                                                                    fontWeight: "700",
                                                                    borderBottom: "1px solid #dcb77c"
                                                                }}>Symposium Delivery</h2>
                                                            </div>
                                                        ...
                                                        <div className="widget">
                                                            <div className="header-h2">
                                                                <h2 style={{textAlign: "center"}}>Restaurant
                                                                    Info <br/> {location.content.name}</h2>
                                                            </div>
                                                            <div>
                                                                ...
                                                                }} className="location-map" frameBorder="0"
                                                                        scrolling="no" marginHeight="0" marginWidth="0"
                                                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2875.672177535187!2d-79.0187647208632!3d43.88334333820645!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0xd49417ded8abbac5!2sSymposium+Caf%C3%A9+Restaurant+%26+Lounge+-+Ajax!5e0!3m2!1sen!2sus!4v1450008202137"/>
                                                            </div>
                                                            <div className="header-h2">
                                                                <h2>Restaurant Hours</h2>
                                                            </div>
                                                            <time
                                                                dateTime="Mo, Tu, We, Th, Fr, Su, Sa 08:00-23:00">Daily
                                                            ...
                                                            <ul className="get-social-list" style={{
                                                                ...
                                                                <li>
                                                                    <Link href={location.facebook} passHref>
                                                                ...
                                                                <li>
                                                                    <a href={location.twiter}>
                                                                        <Image src={Twit} width={32} height={32}
                                                                               alt="Twitter"/>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href={location.yelp}>
                                                                        <Image src={Yelp} width={32} height={32}
                                                                               alt="Yelp"/>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href={location.trip}>
                                                                        <Image src={Trip} width={32} height={32}
                                                                               alt="Trip Advisor"/>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href={location.zomato}>
                                                                        <Image src={Zomato} width={32} height={32}
                                                                               alt="Zomato"/>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="location-maps">
                                                <div className="col-lg-4">
                                                    ...
                                                    <iframe style={{height: "365px"}} frameBorder="0" scrolling="no"
                                                            marginHeight="0" marginWidth="0"
                                                            src={location.content.map}></iframe>
                                                    <div className="location-box-text margin-top-5">Food restaurant near
                                                        me
                                                ...
                                                <div className="col-lg-4"><h3>Symposium Video <br/>
                                                    ...
                                                    <iframe style={{height: "365px"}} src={location.content.youtube}
                                                            frameBorder="0"
                                                            allowFullScreen/>
                                                    <div className="location-box-text margin-top-5">Alliston Ontario
                                                        family
                                                        restaurant near me
                                                    </div>
                                                </div>
                                                <div className="col-lg-4"><h3>Photo Gallery <br/>
                                                    ...
                                                    <div className="location-box-text">Food, breakfast, desserts - a
                                                        great
                                        ...
                                        <div className="col-lg-12">
                                            <div className="location-socials">
                                                <div className="row">
                                                    <div className="col-lg-12">
                                                        <h2>Symposium Cafe Restaurant Reviews
                                                            ({location.content.name})</h2>
                                                        <strong>
                                                            Heres what our guests are saying about their Symposium
                                                            Ancaster experience:
                                                        </strong>
